...
echo '<span class="small">'.$main_street.'</span>'
?>
<br /><a href="/our-location/main-office/<?php echo $address_one_peramiter; ?>"><strong><?php echo $main_city.', '.$main_state ?></strong></a> - <br /><?php // echo $main_phone_number ?><!-- <br><br> -->
<?php if (isset($second_phone_number) && $second_phone_number=="")  {
    ...
    echo " ";
        ...
        echo "<span class='small'>".$second_street."</span><br /><a href=\"/our-location/second-office/".$address_two_peramiter."\"><strong>".$second_city.", ";
    }
...
if (isset($third_phone_number) && $third_phone_number=="")  {
    ...
    echo " ";
        ...
        echo "<span class='small'>".$third_street."</span><br /><a href=\"/our-location/third-office/".$address_three_peramiter."\"><strong>".$third_city.", ";
    }
